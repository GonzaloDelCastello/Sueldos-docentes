...
let calculoBasicoHsSecundario = 15421.3; //11/25
...
function calcularSalarioHsSecundario() {
    ...
    let totalRemunerativo1 = basicoXHs +
        complementoRemunerativo1 +
        bonificacionZona +
        bonificacionAntiguedad;
    let totalNRemunerativo1 = complementoNoRemunerativo1 + sumaNoRemunerativa +
...
function calcularSalarioPreceptor() {
    ...
    let basico1 = 217975.47; //Basico preceptor 11/25
    ...
    let totalRemunerativo1 = basico1 +
...
function calcularSalarioMaestrGrado() {
    ...
    let incentivoDocente = 28700; //Pago por incentivo docente
    let asignacionXHijxs1 = calcularAsignacionXHijxs();
    let totalRemunerativo1 = basico1 + complementoRemunerativo1 + adicionalXCargo1
