...
function mostrarCalculoSecundario() {
  ...
  document.getElementById("adicionalPorCargo").textContent = aPesos(
    resultados.adicionalPorCargo
  );
}
...
//Función calculo cargo preceptor
function mostrarCalculoPreceptor() {
  console.log("Calculando sueldo de preceptor...");
...
function calcularSalarioPreceptor() {
  ...
  let bonificacionZona = calculoBasico * calculoZona();
  let bonificacionAntiguedad = calculoBasico * calculoAntiguedad();
  let complementoRemunerativo1 = calculoBasico * 1.185; //el 1185% del básico
  let complementoNoRemunerativo1 = calculoBasico * 1.185; //el 1185% del básico
  let sumaNoRemunerativa =  65973.47; //Pago de suma no remunerativa
  let incentivoDocente = 28700; //Pago por incentivo docente
  let adicionalPorCargo1 = 66113.88; //Adicional por cargo prec.
  let totalRemunerativo1 =
    calculoBasico +
    complementoRemunerativo1 +
    bonificacionZona +
    bonificacionAntiguedad;
  let totalNRemunerativo1 =
    complementoNoRemunerativo1 + sumaNoRemunerativa + incentivoDocente + adicionalPorCargo1;

  return {
    imponible: calculoBasico,
    pagoDeZona: bonificacionZona,
    pagoAntiguedad: bonificacionAntiguedad,
    complementoRemunerativo: complementoRemunerativo1,
    complementoNoRemunerativo: complementoNoRemunerativo1,
    ...
    totalRemunerativo: totalRemunerativo1,
    totalNRemunerativo: totalNRemunerativo1,
    adicionalPorCargo: adicionalPorCargo1
  };
}
