...
export interface ConfiguracionSalarial {
    ...
    basicoHoraCatedra: number; // EL VALOR CLAVE
    porcentajes: {
...
export function obtenerConfiguracionActual(fecha?: string): ConfiguracionSalarial {
...
export function calcularBasicoCargo(tipoCargo: keyof typeof COEFICIENTES_CARGOS, config: ConfiguracionSalarial): number {
